...
#Metaweb
Metaweb <- read.csv2(file = "~/Documents/Maitrise/BD/BD Dom/BD_Genus/Metaweb_vertebrate_Genus.csv", stringsAsFactors = F, row.names = "X")
...
# Phylogenetic tree
phylo.tree.time <- phylobase::readNewick("../Phylo_Nets_Galapagos/Data_madelaine/Time_tree.nwk")
...
#retirer les espèces pour lesquelles on n'a pas d'info sur la phylogénie
