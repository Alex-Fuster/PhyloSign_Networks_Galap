...
```{r}
interact_databade <- read.csv("../Phylo_Nets_Galapagos/Data_madelaine/Interactions.csv",sep=";", header = TRUE)
cleared.metaweb<-readRDS("../Phylo_Nets_Galapagos/Data_madelaine/Metaweb_pariles_vertebrate_Genus.RDS", refhook = NULL)
sp_list<-read.csv("../Phylo_Nets_Galapagos/Data_madelaine/sp_list.csv",sep=";", header = TRUE)
cleared.interact_db<-readRDS("../Phylo_Nets_Galapagos/Data_madelaine/Inter_predproie_extrapoles_Genus_invertebresgenus_07122020.RDS", refhook = NULL)
```
...
Create simple network, and plot distance vs dimensionality.
...
Calculating distance matrices as Madelaine did
...
#Method for finding the wright dimensionality
